...
class ControladorVentanaPrincipal:
    ...
    def _conectar_navegacion(self):
        ...
        v.btn_inventario.clicked.connect(lambda: v.area_contenido.setCurrentIndex(2))
        v.btn_reportes.clicked.connect(lambda: v.area_contenido.setCurrentIndex(3))
        v.btn_dashboard.clicked.connect(lambda: v.area_contenido.setCurrentIndex(4))
        v.btn_configuracion.clicked.connect(lambda: v.area_contenido.setCurrentIndex(5))
